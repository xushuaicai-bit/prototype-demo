    ...
    <div class="flex flex-wrap gap-4 mb-4 p-3 bg-gray-50 rounded-lg">
      ...
      <div class="flex items-center">
        ...
        <el-select v-model="filters.location" placeholder="请选择" class="w-32">
          ...
          <el-option label="上海闵行" value="上海闵行" />
          <el-option label="广州天河" value="广州天河" />
          <el-option label="北京朝阳" value="北京朝阳" />
          <el-option label="江苏苏州" value="江苏苏州" />
          <el-option label="四川成都" value="四川成都" />
          <el-option label="浙江杭州" value="浙江杭州" />
          <el-option label="湖北武汉" value="湖北武汉" />
          <el-option label="广东深圳" value="广东深圳" />
          <el-option label="陕西西安" value="陕西西安" />
        </el-select>
      </div>
      <div class="flex items-center">
...
const totalAmount = computed(() => {
  return filteredData.value.reduce((sum, item) => sum + item.bidPrice, 0)
})
