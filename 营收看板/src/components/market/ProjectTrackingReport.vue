        ...
        >
          <template #default="scope">
            <div class="flex flex-col items-center">
              ...
              <span class="text-xs text-gray-600 font-medium">{{ formatNumber(scope.row.subtotal.amount) }}</span>
            </div>
          </template>
        </el-table-column>
        <el-table-column
...
const tableData = ref([
  ...
  { branch: '城水管管道', aaa: { count: 2, amount: 16000000 }, aa: { count: 4, amount: 12000000 }, a: { count: 6, amount: 9000000 }, subtotal: { count: 12, amount: 37000000 }, percentage: '6.5%' },
